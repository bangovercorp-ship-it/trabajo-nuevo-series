...
## Los roles que crearon la serie
...
| 7 | **Director de cine** | 🔄 | **La lista de planos del episodio 1 está hecha**, con las nueve tomas, el diálogo por toma, el sonido, el subtítulo, las referencias, la tabla de continuidad y el costo: `12-episodio-1-lista-de-planos.md`. Falta escribir los once prompts de cuadro y los ocho de movimiento, y hacer lo mismo con los episodios 2 a 8 |
...
- **El rol 5 pasó de pendiente a urgente.** Cambió el país y cambió la regla: un suplemento en Ecuador responde a la autoridad sanitaria ecuatoriana, no a la peruana. Hay que verificar qué se puede afirmar en una pieza publicitaria, qué registro debe tener el producto y qué exige TikTok para el rubro de salud masculina. Mientras esto no esté revisado, se puede producir pero no publicar.
...
1. **Rol 11 y 6**, que van juntos: planos y maqueta nuevos, después las imágenes. Es lo único que no depende de nadie más.
2. **Rol 8**, voces con acento costeño, que se puede hacer en paralelo.
3. **Rol 7**, lista de planos del episodio 1, ya con las imágenes nuevas en la mano.
4. **Rol 5**, cumplimiento, antes de publicar nada.
5. **Rol 10**, estrategia de publicación, junto con el 5.
6. **Rol 13**, validación del habla, antes de grabar voces definitivas.
7. **Rol 4**, revisión de sesgos episodio por episodio, al final, cuando los guiones ya no se muevan.
